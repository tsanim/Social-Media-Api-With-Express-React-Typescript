...
import ChangePasswordFormProps from '../../interfaces/Components/Forms/ChangePasswordFormProps.interface';
import { ChangePassword } from '../../interfaces/Components/EditUserInformation/EditUserInfoProps.interface';
...
function ChangePasswordForm({ changePasswordHandler, createSnackbar, errors: serverErrors, resetErrorsHandler }: ChangePasswordFormProps) {
    const handleSubmit = (form: ChangePassword) => {
