...
import CommentFormProps from '../../interfaces/Components/Forms/CommentFormProps.interface';

export function CommentForm({ postId, makeCommentHandler, createSnackbar }: CommentFormProps) {
