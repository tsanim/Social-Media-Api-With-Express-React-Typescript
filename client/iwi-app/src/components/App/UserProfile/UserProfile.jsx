...
function mapDispatchToProps(dispatch) {
    return {
        follow: (userId) => dispatch(UsersService.followUser(userId)),
        unfollow: (userId) => dispatch(UsersService.unfollowUser(userId)),
        getUserInfo: (userId) => dispatch(UsersService.getUser(userId)),
