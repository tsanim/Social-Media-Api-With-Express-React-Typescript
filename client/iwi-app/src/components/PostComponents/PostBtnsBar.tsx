...
import PostBtnsBarProps from '../../interfaces/Components/PostComponents/PostBtnsBarProps.interface';

function PostBtnsBar(props: PostBtnsBarProps) {
    return (
        <div className={props.btnsDivClassName}>
            <div className="left">
                ...
                <button style={(props.areCommentsShown ? { color: "#8AAAE5" } : { color: 'inherit' })} onClick={props.handleShowComments}><FontAwesomeIcon icon={faComment} /></button>
            </div>
